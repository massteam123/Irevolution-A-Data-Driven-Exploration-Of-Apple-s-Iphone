...
// DEPENDS ON: ['scriptsharp/src/Resources/Strings/Strings.en.resx', 'scriptsharp/src/Resources/Strings/Strings.en_GB.resx', 'scriptsharp/src/Resources/Strings/resx-strings-js.template']
...
(function(w) {
  var s = {
    ...
    AccelerationDisallowedReason_AccelerationFutileNull: "Acceleration uses load data for the viz, which takes time to collect. Check again later.",
    ...
    AccelerationFailedTooltip: "Acceleration failed for this view, click to turn off acceleration.",
    ...
    AccessibilityDataVisualizationTitleAttr: "Data Visualisation",
    ...
    AddToLabel: "Add to:",
    AggregateCalcWarning: "This field contains an aggregate calculation which only contains meaningful data in the visualisation\'s level of detail.",
    ...
    AuthColorEditingDisabled: "Combine legends to edit colours here or edit the colours for each individual legend.",
    AuthColorPaletteAutomatic: "Automatic",
    AuthColorPaletteLegacy: "Discontinued",
    AuthColorPaletteMoreColors: "More Colours...",
    AuthColorPaletteNone: "None",
    AuthColorTransparencyLabel: "Opacity",
    AuthConnectToDataSource: "Connect to a Data Source on {0}",
    AuthCustomHexColorLabel: "Custom Colour",
    ...
    AuthLabelEditingDisabledShow: "In order to edit mark labels, tick the \"Show Mark Labels\" box.",
    ...
    AuthMastheadDone_Confirm_Datasource_Description: "Do you want to save your changes in a new data source?",
    AuthMastheadDone_Confirm_Datasource_Title: "Save Data source",
    ...
    ConnectionDialogSubtitleCreateAndConnect: "Connect to the data you need to visualise.",
    ...
    DataAlertLoadCustomizedViewFailure: "Unable to load customised view",
    ...
    DataInterpreterUndo: "To undo changes, clear the tick box.",
    ...
    DataTabUnionInvalidPillTooltip: "Tableau can\'t find or recognise this table. Remove or replace the table",
    ...
    ExtensionRequiresAuthorization: "{0}<br><br>The {0} extension requires authorisation to run. The authorisation page could take a few moments to appear. To reauthorise, reload the page in your browser.",
    ...
    MetaDataGrid_ConnectionColor: "Connection Colour",
    ...
    PasteDashboardItemFailureMessage: "We encountered an error while trying to paste that object. Please try pasting again. If you still encounter issues, contact your administrator for more assistance.",
    ...
    QuantitativeColorCenter: "Centre",
    QuantitativeColorDialogTitle: "Edit Colours {0}",
    QuantitativeColorEnableSteps: "Stepped colour",
    QuantitativeColorEnd: "End",
    QuantitativeColorEndSwatch: "End colour, custom colour {0}",
    QuantitativeColorFullColorRange: "Use full colour range",
    ...
    QuantitativeColorStartSwatch: "Start colour, custom colour {0}",
    ...
    RunOptimizer: "Run Optimiser…",
    RuntimeAccessibilityEnclosingDivPressEnterTab: "Press Enter to navigate the data visualisation. Press tab to navigate to the next object.",
    ...
    RuntimeAccessibilitySceneMarginWithHeadersScreenReaderText: "{0}, {1} margin. Press Enter to navigate inside the margin. Press Escape to go back to the {2}. Use arrow keys to navigate data visualisation elements.",
    RuntimeAccessibilitySceneScreenReaderText: "Marks. {0}. Use arrow keys to navigate data visualisation elements.",
    ...
    SessionForbiddenActionMsg: "You are not authorised to perform this action.",
    ...
    TabAuthCategoricalColorEditorSelectPalette: "Select Colour Palette",
    TabAuthColorEditButton: "Edit Colours...",
    TabAuthColorEditLabel: "Colour",
    TabAuthColorEditLegendButtonTooltip: "Edit Colours...",
    TabAuthColorEditorDialogTitle: "Edit Colours [{0}]",
    ...
    TimeLimitExceededWarning: "Computing the current visualisation has exceeded the session time limit.",
    ...
    ToolbarCustomViewsButtonDescription: "Save my customisations, or see other custom views",
    ...
    WindowTableCalcSummarizeUsing: "Summarise values using",
    ...
    WorkbookOptimizer: "Workbook Optimiser",
